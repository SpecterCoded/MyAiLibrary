...
$url = "https://github.com/BtbN/FFmpeg-Builds/releases/download/autobuild-2026-07-18-13-13/ffmpeg-N-125658-g0869e710e6-win64-lgpl.zip"
$expectedArchive = "0F585B6F171104B6CB033A6C4B14EDAEE13BA43121C954B46E211437C44A23FE"
...
$actualArchive = (Get-FileHash -Algorithm SHA256 -LiteralPath $archive).Hash
if ($actualArchive -ne $expectedArchive) {
    throw "Downloaded FFmpeg archive failed the pinned SHA-256 integrity check."
}
