...
contextBridge.exposeInMainWorld('desktop', {
  ...
  setRefreshToken: (refreshToken: string): Promise<boolean> => ipcRenderer.invoke('desktop:set-refresh-token', refreshToken),
  getRefreshToken: (): Promise<string | null> => ipcRenderer.invoke('desktop:get-refresh-token'),
  clearRefreshToken: (): Promise<boolean> => ipcRenderer.invoke('desktop:clear-refresh-token'),
