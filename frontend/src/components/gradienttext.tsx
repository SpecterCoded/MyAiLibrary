...
export function GradientText({
    ...
    return (
        <>
            ...
            <div
                className={`relative mx-auto flex max-w-fit flex-row items-center justify-center rounded-[1.25rem] font-medium backdrop-blur transition-shadow duration-500 cursor-pointer px-2 ${className}`}
            >
            {showBorder && (
                <div
