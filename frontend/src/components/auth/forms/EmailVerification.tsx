  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      <button 
        ...
        className="group mb-6 inline-flex items-center gap-2 text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors"
        aria-label="Go back"
      >
        <div className="w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center group-hover:bg-gray-50 group-hover:border-gray-300 transition-all">
      ...
      <div className="bg-white rounded-3xl border border-gray-100 shadow-xl shadow-gray-100/50 p-6 sm:p-8 relative overflow-hidden">
        ...
        <div className="relative flex flex-col items-center text-center">
          ...
          <div className="relative mb-6">
            <div className="absolute inset-0 bg-blue-500/20 rounded-2xl blur-md scale-95 animate-pulse"></div>
          ...
          {/* Styled Email Pill */}
          <div className="w-full bg-gray-50 rounded-xl px-4 py-3 border border-gray-100/80 mb-6 flex items-center justify-center gap-2 select-all font-mono text-sm text-gray-800 break-all">
          ...
          {checking && (
            <div className="w-full py-4 flex flex-col items-center justify-center gap-2 text-blue-600 bg-blue-50/50 rounded-xl mb-4 border border-blue-100">
          ...
          {error && (
            <div className="w-full mb-6 p-4 text-sm text-red-700 bg-red-50/80 backdrop-blur-sm rounded-xl border border-red-100 flex items-start gap-2.5 text-left">
          ...
          {resendMessage && (
            <div className="w-full mb-6 p-4 text-sm text-emerald-700 bg-emerald-50/80 backdrop-blur-sm rounded-xl border border-emerald-100 flex items-start gap-2.5 text-left">
          ...
          <div className="mt-6 text-sm text-gray-500">
            ...
            <button 
              ...
              className="font-bold text-blue-600 hover:text-indigo-600 transition-colors disabled:opacity-50"
            >
              Click to resend
            </button>
          </div>
